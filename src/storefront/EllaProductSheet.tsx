...
export function EllaProductSheet({
  ...
  const stockLine = canBuy
    ? size?.low
      ? `Only ${size.available} left in ${size.label} · live from studio stock`
      : `${size?.stockLabel} in ${size?.label} · live from studio stock`
    : "Sold out in this size — we can cut it to order in 3–4 weeks";
    ...
    <>
      ...
      >
        <div className="ella-sheet-scroll">
          <div className="ella-sheet-head ella-pdp-mobile-head">
          ...
          <div className="ella-pdp">
            ...
            <div className="ella-pdp-info">
              <button type="button" className="ella-close ella-pdp-close" onClick={onClose} aria-label="Close">
                ×
              </button>
              ...
              <div className="ella-size-head">
                ...
                <button
                  type="button"
                  className="ella-link-underline ella-size-guide-link"
              ...
              <div className={`ella-stock-note${size?.low ? " ella-stock-note-low" : ""}`}>{stockLine}</div>
              ...
              <div className="ella-qty-row">
                <span className="ella-eyebrow">Qty</span>
