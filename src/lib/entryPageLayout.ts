...
export const FILL_HEIGHT_DASHBOARD_PATH =
  /\/(pos-dashboard|sales-invoice-dashboard|purchase-bills|purchase-bill-dashboard|accounts|customer-party-balances|supplier-party-balances|stock-report|item-wise-sales|item-wise-stock|customer-master|net-profit-analysis|reports)(\/|$)/;
...
export const SIDEBAR_ONLY_WORKSPACE_PATH =
  /\/(customer-party-balances|supplier-party-balances|stock-report|accounts|item-wise-sales|item-wise-stock|net-profit-analysis)(\/|$)/;
