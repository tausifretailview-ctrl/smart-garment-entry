...
export const NO_SIDEBAR_ENTRY_PATH =
  /\/(pos-sales|pos-delivery-challan|sales-invoice|purchase-entry|purchase-return-entry|sale-order-entry)(\/|$)/;
...
export const FILL_HEIGHT_DASHBOARD_PATH =
  /\/(pos-dashboard|sales-invoice-dashboard|purchase-bills|purchase-bill-dashboard|barcode-printing|accounts|accounts-payments|customer-party-balances|customer-outstanding-report|supplier-party-balances|third-party-entry|third-party-balances|journal-vouchers|manual-journal|stock-report|stock-settlement|item-wise-sales|item-wise-stock|customer-master|employees|net-profit-analysis|reports|insights|daily-cashier-report|discount-scheme-dashboard|gst-register|gst-reports|accounting-reports|settings|website|recycle-bin|salesman-commission)(\/|$)/;
...
export const SIDEBAR_ONLY_WORKSPACE_PATH =
  /\/(customer-party-balances|customer-outstanding-report|supplier-party-balances|third-party-entry|third-party-balances|journal-vouchers|manual-journal|stock-report|stock-settlement|accounts|accounts-payments|item-wise-sales|item-wise-stock|net-profit-analysis|insights|daily-cashier-report|gst-register|gst-reports|barcode-printing|accounting-reports|settings|website|recycle-bin|salesman-commission)(\/|$)/;
...
export const ENTRY_SIDEBAR_ONLY_PATH =
  /\/(quotation-entry|delivery-challan-entry|sale-return-entry|purchase-order-entry)(\/|$)/;
