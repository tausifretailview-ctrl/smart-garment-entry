...
const DEFAULT_PRECISION_CONFIG: LabelDesignConfig = {
  ...
  saleDiscPercent: { show: false, fontSize: 7, bold: false, x: 30, y: 11, width: 18, textAlign: "right" },
  ...
  fieldOrder: ["businessName", "brand", "productName", "category", "color", "style", "size", "price", "mrp", "saleDiscPercent", "qty", "barcode", "barcodeText", "customText", "billNumber", "supplierCode", "purchaseCode", "supplierInvoiceNo"],
  barcodeHeight: 30,
  barcodeWidth: 1.5,
  customTextValue: "",
  customTextFields: [],
