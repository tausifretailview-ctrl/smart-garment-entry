...
const posShortcuts: ShortcutGroup[] = [
  {
    title: "POS Actions",
    shortcuts: [
      { keys: ["F1"], description: "New Sale" },
      { keys: ["F2"], description: "Save & Print (Cash)" },
      { keys: ["F3"], description: "Save & Print (UPI)" },
      { keys: ["F4"], description: "Mix Payment" },
      { keys: ["F5"], description: "Save & Print (Card)" },
      { keys: ["F6"], description: "Pay Later" },
