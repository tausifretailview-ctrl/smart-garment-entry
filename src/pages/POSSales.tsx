...
export default function POSSales() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        // Clear snapshot so the offscreen wrapper unmounts and frees memory.
  ...
  /**
   * Snapshots current cart/customer state into the props the offscreen
   * <InvoiceWrapper> needs, then returns a promise that resolves with the
   * base64 PDF (or null on failure). Called by useSaveSale via runtimeOptions.
   */
