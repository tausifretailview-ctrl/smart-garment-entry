...
export default function Accounts() {
  ...
  const { data: failedJournalRowsRaw, isLoading: failedRowsLoading } = useQuery({
  ...
  const failedJournalRows = failedJournalRowsRaw ?? [];
        ...
        >
          {currentOrganization?.id && (
            <>
              ...
              {shouldMountTab("customer-payment") && (
