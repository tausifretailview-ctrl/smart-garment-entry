...
const ThirdPartyBalancesPage = lazyWithRetry(() => import("./pages/accounts/ThirdPartyBalancesPage"));
...
const CustomerOutstandingReport = lazyWithRetry(() => import("./pages/CustomerOutstandingReport"));
              ...
              <Route path="/:orgSlug" element={<OrgLayout />}>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute>
                      <Layout>
                        <SupplierPartyBalancesPage />
                      </Layout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="orphaned-products"
                  element={
                    <ProtectedRoute>
                      <Layout>
                        <OrphanedProductsPage />
                      </Layout>
                    </ProtectedRoute>
                  }
                />
                ...
                />
                <Route
                  path="third-party-balances"
                  element={
                    <ProtectedRoute>
                      <RoleProtectedRoute allowedRoles={["admin", "manager"]}>
                        <Layout>
                          <ThirdPartyBalancesPage />
                        </Layout>
                      </RoleProtectedRoute>
                    </ProtectedRoute>
                  }
