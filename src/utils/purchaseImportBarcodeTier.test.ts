...
describe("purchaseImportBarcodeTier", () => {
  it("splits Jockey universal EAN by sale/MRP tier", () => {
    expect(barcodeTierLookupKey("8901326444238", 578, 549)).toBe("8901326444238::578.00");
    expect(barcodeTierLookupKey("8901326444238", 598, 569)).toBe("8901326444238::598.00");
    expect(
