...
export const INVOICE_PRINT_VISIBILITY_OVERRIDE_CSS = `
  @media print {
    ...
    body .kids-camp-thermal-receipt-80mm *,
    body .vastrakala-thermal-receipt-80mm,
    body .vastrakala-thermal-receipt-80mm *,
...
export const THERMAL_RECEIPT_PAGE_BREAK_OVERRIDE_CSS = `
  @media print {
    .invoice-print-root:has(.thermal-print-80mm, .thermal-receipt-container, .modern-thermal-receipt, .kids-thermal-receipt-80mm, .kids-camp-thermal-receipt-80mm, .vastrakala-thermal-receipt-80mm),
    .invoice-print-root:has(.thermal-print-80mm, .thermal-receipt-container, .modern-thermal-receipt, .kids-thermal-receipt-80mm, .kids-camp-thermal-receipt-80mm, .vastrakala-thermal-receipt-80mm) *,
    .print-thermal,
    .thermal-print-80mm,
...
export function buildThermalReceiptPrintCss(
  ...
  .vastrakala-thermal-receipt-80mm[data-thermal-paper="58mm"],
...
export function isThermalReceiptHtml(html: string): boolean {
  return /thermal-print-80mm|thermal-receipt-container|modern-thermal-receipt|kids-thermal-receipt-80mm|kids-camp-thermal-receipt-80mm|vastrakala-thermal-receipt-80mm/i.test(
    html,
  );
}
