...
--
-- Run ONE block. SET statement_timeout first.
--
-- WARNING: Full org (2,377 customers × reconcile per row) → Lovable "Server Error"
-- (gateway timeout). Use drift-only or smoke scripts instead:
--   prove-snapshot-all-equivalence-step4-smoke.sql        (1 customer, ~seconds)
--   prove-snapshot-all-equivalence-step4-sql-editor-safe-drift-only.sql (~113 rows)
--
