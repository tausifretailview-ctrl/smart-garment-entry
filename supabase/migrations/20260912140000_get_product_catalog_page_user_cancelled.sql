...
COMMENT ON FUNCTION public.get_product_catalog_page(uuid, integer, integer, text, text, text, uuid, text, numeric, numeric) IS
  'Paginated Product Master rows with variant aggregates and user_cancelled_at for draft-cancel badge.';

GRANT EXECUTE ON FUNCTION public.get_product_catalog_page(uuid, integer, integer, text, text, text, uuid, text, numeric, numeric)
