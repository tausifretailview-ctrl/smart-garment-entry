-- POS dashboard / cashier: Sale Amount (totalAmount) must include rate-only DC bills where gross_amount=0.
-- Mirrors getSaleReportGrossAmount in src/utils/cashierReportUtils.ts
