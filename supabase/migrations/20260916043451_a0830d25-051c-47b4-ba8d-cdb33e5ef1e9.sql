-- fix_detect_settlement_drift_phantom_credit_return_adjust
...
BEGIN
  ...
  classified AS (
    SELECT
      ...
      GREATEST(0::numeric, c.credit_applied - c.sale_return_adjust) AS unbacked_credit,
      (c.net_amount - c.recorded_paid - c.sale_return_adjust) AS residual,
      CASE
        WHEN NOT c.has_credit_backing
             AND (c.credit_applied - c.sale_return_adjust) > 0.01
          THEN 'PHANTOM_CREDIT'
