-- Item-wise Stock: barcode group-by, barcode filter, closing-stock filter (in_stock / zero_stock).

DROP FUNCTION IF EXISTS public.get_product_wise_stock_report_totals(uuid, text, text, text, text, text, text);
DROP FUNCTION IF EXISTS public.get_product_wise_stock_report(uuid, integer, integer, text, text, text, text, text, text);
...
COMMENT ON FUNCTION public.get_product_wise_stock_report_totals(uuid, text, text, text, text, text, text, text, text) IS
  'Grand totals for Item-wise Stock Report — supports barcode filter and closing-stock filter.';
...
GRANT EXECUTE ON FUNCTION public.get_product_wise_stock_report_totals(uuid, text, text, text, text, text, text, text, text) TO authenticated, service_role;
