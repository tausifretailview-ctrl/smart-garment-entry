-- Credit note applied to invoice / customer: DR Sales Returns (4050), CR AR.
...
CREATE INDEX IF NOT EXISTS idx_journal_entries_org_ref_cust_cn
  ON public.journal_entries (organization_id, reference_type, reference_id)
  WHERE reference_type = 'CustomerCreditNoteApplication';
