-- =============================================================================
-- Deploy: Purchase Bill Dashboard stats RPC
-- Run in Supabase Dashboard → SQL Editor → New query → Paste → Run
-- Fixes console 404: get_purchase_bill_dashboard_stats on Purchase Dashboard
-- Source: supabase/migrations/20260607200000_get_purchase_bill_dashboard_stats.sql
-- =============================================================================
