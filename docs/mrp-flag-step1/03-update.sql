-- STEP 1c — Set show_mrp = true ONLY where the key is absent/null.
-- Expect: UPDATE 14
-- Any other count: STOP and report. Do not proceed to Step 2.

update settings
set purchase_settings = coalesce(purchase_settings, '{}'::jsonb)
                        || '{"show_mrp": true}'::jsonb
where organization_id in (
  ...
  and purchase_settings->>'show_mrp' is null;
