-- STEP 1a — Backup (export result to CSV before 1c)
-- Save as: docs/mrp-flag-step1/backup-purchase_settings-<YYYYMMDD>.csv

select organization_id, purchase_settings
from settings
