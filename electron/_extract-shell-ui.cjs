/**
 * Extract HEADER_CSS + HINT_BAR_JS from main.cjs into shell-ui.cjs
 * and write security.cjs. Run: node electron/_extract-shell-ui.cjs
 */
const fs = require('fs');
...
const sample = require('./shell-ui.cjs').buildHintBarJs('1.2.0');
...
console.log('wrote shell-ui.cjs + security.cjs');
console.log('HEADER_CSS length', HEADER_CSS.length);
console.log('HINT_BAR length', hintWithPlaceholder.length);
